# Probability Theory Course Materials

# 1. Probability Spaces

## 1.1 The Sample Space 
### Readings
1. Probability and Counting (Chapter 1.1 to 1.3 [2])
2. Probability Spaces (Chapter 1.1 to 1.3 [1])

### Videos and Slides
(4/02/2026) 1. Introduction to Probability [Youtube](https://youtu.be/SPSF-T04TaQ), [Slides](https://drive.google.com/file/d/1bmilHVRnvjap9lQnOHU6AvJemsogaTcv/view?usp=sharing).
...
[1] Venkatesh, Santosh S. _The Theory of Probability: Explorations and Applications_. Cambridge University Press, 2013.

[2] Blitzstein, J.K., and J. Hwang. _Introduction to Probability, Second Edition_. Chapman & Hall/CRC Texts in Statistical Science. CRC Press, 2019.